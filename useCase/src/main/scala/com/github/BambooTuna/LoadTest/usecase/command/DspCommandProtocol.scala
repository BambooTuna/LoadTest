...
import com.github.BambooTuna.LoadTest.domain.model.budget.{ BudgetBalance, BudgetDifferencePrice }
...
object DspCommandProtocol {
  ...
  sealed trait AssociateBidRequestIdAndAdvertiserIdCommandResponse extends CommandResponse

  sealed trait ReduceBudgetFromWinNoticeCommandResponse extends CommandResponse
  /////////////////////////////
  ...
  case class ReduceBudgetFromWinNoticeCommandRequest(bidRequestId: BidRequestId, usedPrice: BudgetDifferencePrice)
      extends CommandRequest
  ////////////////////////////////////
  ...
  case class AssociateBidRequestIdAndAdvertiserIdCommandFailed(error: String)
      extends AssociateBidRequestIdAndAdvertiserIdCommandResponse

  case object ReduceBudgetFromWinNoticeCommandSucceeded            extends ReduceBudgetFromWinNoticeCommandResponse
  case object ReduceBudgetFromWinNoticeCommandNoClick              extends ReduceBudgetFromWinNoticeCommandResponse
  case class ReduceBudgetFromWinNoticeCommandFailed(error: String) extends ReduceBudgetFromWinNoticeCommandResponse
  ////////////
