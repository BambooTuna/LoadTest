...
```sbtshell//
$ curl -X POST -H "Content-Type: application/json" -d '{"id":"1","timestamp":1234567890,"device_id":"1","banner_size":1,"media_id":1,"os_type":1,"banner_position":1,"is_interstitial":1,"floor_price":1.0,"ext":[]}' http://34.84.137.136:8080/bid_request
...
```sbtshell
loadtest-deployment-646d5bc85-fngnb 
kubectl cp ./foot_converted.csv loadtest-deployment-646d5bc85-fngnb:/opt/docker/sample_user_up.csv
kubectl exec -it loadtest-deployment-646d5bc85-fngnb sh
kubectl logs -f loadtest-deployment-646d5bc85-fngnb 
